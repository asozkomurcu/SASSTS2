...
namespace SASSTS2.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "CUSTOMER_DEPARTMENT_DEPARTMENT_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "PURCHASE_REQUEST_CUSTOMER_CUSTOMER_ID",
                        column: x => x.CUSTOMER_ID,
                        principalTable: "CUSTOMERS",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PRODUCT_REQUEST", x => x.ID);
                    table.ForeignKey(
                        name: "FK_PRODUCT_REQUEST_PURCHASE_REQUEST_PURCHASE_REQUEST_ID",
                        column: x => x.PURCHASE_REQUEST_ID,
                        principalTable: "PURCHASE_REQUEST",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "PRODUCT_REQUEST_CUSTOMER_CUSTOMER_ID",
                        column: x => x.CUSTOMER_ID,
                        principalTable: "CUSTOMERS",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_PRODUCTS_PRODUCT_REQUEST_ProductRequestId",
                        column: x => x.ProductRequestId,
                        principalTable: "PRODUCT_REQUEST",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PRODUCT_REQUEST_CUSTOMER_ID",
                table: "PRODUCT_REQUEST",
                column: "CUSTOMER_ID");

            migrationBuilder.CreateIndex(
                name: "IX_PRODUCT_REQUEST_PRODUCT_ID",
                table: "PRODUCT_REQUEST",
                column: "PRODUCT_ID");

            migrationBuilder.CreateIndex(
                name: "IX_PRODUCT_REQUEST_PURCHASE_REQUEST_ID",
                table: "PRODUCT_REQUEST",
                column: "PURCHASE_REQUEST_ID",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PRODUCTS_ProductRequestId",
                table: "PRODUCTS",
            ...
            migrationBuilder.AddForeignKey(
                name: "PRODUCT_REQUEST_PRODUCT_PRODUCT_ID",
                table: "PRODUCT_REQUEST",
                column: "PRODUCT_ID",
                principalTable: "PRODUCTS",
                principalColumn: "ID",
