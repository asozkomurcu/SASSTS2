...
namespace SASSTS2.Persistence.Migrations
{
    ...
    [Migration("20231010214903_FirstCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Bill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.PriceOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.ProductRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PRODUCT_REQUEST", (string)null);
                });

            modelBuilder.Entity("SASSTS2.Domain.Entities.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.PurchasedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Wholesaler", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Account", b =>
                {
                    b.HasOne("SASSTS2.Domain.Entities.Customer", "Customer")
                        .WithOne("Account")
                        .HasForeignKey("SASSTS2.Domain.Entities.Account", "CustomerId")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Bill", b =>
                {
                    b.HasOne("SASSTS2.Domain.Entities.Product", "Product")
                        .WithMany("Bills")
                    ...
                    b.HasOne("SASSTS2.Domain.Entities.Wholesaler", "Wholesaler")
                        .WithMany("Bills")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Customer", b =>
                {
                    b.HasOne("SASSTS2.Domain.Entities.Department", "Department")
                        .WithMany("Customers")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Department", b =>
                {
                    b.HasOne("SASSTS2.Domain.Entities.Company", "Company")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.PriceOffer", b =>
                {
                    ...
                    b.HasOne("SASSTS2.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithMany("PriceOffers")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.Product", b =>
                {
                    b.HasOne("SASSTS2.Domain.Entities.Bill", null)
                        .WithMany("Products")
                        .HasForeignKey("BillId");

                    b.HasOne("SASSTS2.Domain.Entities.Category", "Category")
                        .WithMany("Products")
                    ...
                    b.HasOne("SASSTS2.Domain.Entities.PriceOffer", null)
                        .WithMany("Products")
                        .HasForeignKey("PriceOfferId");

                    b.HasOne("SASSTS2.Domain.Entities.ProductRequest", null)
                        .WithMany("Products")
                        .HasForeignKey("ProductRequestId");

                    b.HasOne("SASSTS2.Domain.Entities.PurchasedProduct", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.ProductRequest", b =>
                {
                    ...
                    b.HasOne("SASSTS2.Domain.Entities.PurchaseRequest", "PurchaseRequest")
                        .WithOne("ProductRequest")
                        .HasForeignKey("SASSTS2.Domain.Entities.ProductRequest", "PurchaseRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SASSTS2.Domain.Entities.PurchasedProduct", b =>
                {
                    ...
                    b.HasOne("SASSTS2.Domain.Entities.PriceOffer", "PriceOffers")
                        .WithMany("PurchasedProducts")
                        .HasForeignKey("PriceOfferId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
